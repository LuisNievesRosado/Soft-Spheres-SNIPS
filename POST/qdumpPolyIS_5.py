...
#	Z.sort()
	...
	L1_SVPS4.append(countS4)
	L1_SVPS5.append(countS5)	
	...
	L1P_ISV4.append(100*countI4/(countI+countS))	
	L1P_ISV5.append(100*countI5/(countI+countS))		
	...
	L1P_SVPS4.append(100*countS4/(countI+countS))	
	L1P_SVPS5.append(100*countS5/(countI+countS))	
	...
	L2_SVPS4.append(countS4)
	L2_SVPS5.append(countS5)	
	...
	L2P_ISV4.append(100*countI4/(countI+countS))	
	L2P_ISV5.append(100*countI5/(countI+countS))		
	...
	L2P_SVPS4.append(100*countS4/(countI+countS))	
	L2P_SVPS5.append(100*countS5/(countI+countS))	
...
plt.plot(L1_SVPS4,linewidth=2.0,label='SVPS4')
plt.plot(L1_SVPS5,linewidth=2.0,label='SVPS5')
plt.legend()
...
plt.plot(L2_SVPS4,linewidth=2.0,label='SVPS4')
plt.plot(L2_SVPS5,linewidth=2.0,label='SVPS5')
plt.legend()
